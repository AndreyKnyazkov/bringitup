...
function () {
  function Form(forms) {
    ...
    this.forms = document.querySelectorAll(forms); //messages
...
function () {
  function VideoPlayer(triggers, overlay) {
    ...
    this.btns = document.querySelectorAll(triggers); //overlay for that

    this.overlay = document.querySelector(overlay); //close btn to close the modal
  ...
  _createClass(VideoPlayer, [{
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          ...
          if (document.querySelector('iframe#frame')) {
            _this.overlay.style.display = 'flex'; //if it did not create it
          } else {
    ...
    value: function init() {
      if (this.btns.length > 0) {
        //create a script
        var tag = document.createElement('script'); //bind youtube API

        tag.src = "https://www.youtube.com/iframe_api";
        var firstScriptTag = document.getElementsByTagName('script')[0];
        firstScriptTag.parentNode.insertBefore(tag, firstScriptTag); //to bind triggers

        this.bindTriggers(); //to close the modal
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      console.log(this.slides.length); //if the variable become more than we need then set 1
      ...
      } catch (e) {} //everything to display none
    ...
    key: "bindTriggers",
    value: function bindTriggers(arrow, target) {
      var _this2 = this;
      ...
      this.btns.forEach(function (item) {
        ...
        item.parentNode.previousElementSibling.addEventListener('click', function (e) {
          e.preventDefault();
          _this2.slideIndex = 1; //change the variable
    ...
    value: function render() {
      if (this.container) {
        ...
        } catch (e) {} //to initializate our slider
...
/*#__PURE__*/
function (_Slider) {
  _inherits(MultiSlider, _Slider);

  function MultiSlider(container, next, prev, activeClass, animate, autoplay) {
    var _this;

    _classCallCheck(this, MultiSlider);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(MultiSlider).call(this, container, next, prev, activeClass, animate, autoplay));

    try {
      _this.currentSlides = _toConsumableArray(_this.slides).filter(function (val) {
        return val.nodeName !== "BUTTON";
      }), _this.targetSlide = _this.currentSlides.length, _this.sliderParent = _this.slides[0].parentNode;
    } catch (e) {}
  ...
  _createClass(MultiSlider, [{
    ...
    value: function decorizeSlides() {
      ...
      this.slides.forEach(function (slide) {
        slide.classList.remove(_this2.activeClass); //remove classes if the animation argument was passed
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        ...
        _this3.sliderParent.insertBefore(_this3.slides[_this3.currentSlides.length - 1], _this3.sliderParent.firstElementChild);
    ...
    value: function autoplaySlide() {
      ...
      var startPlay = setInterval(function () {
        return _this4.nextSlide();
          ...
          sliderParent = this.slides[0].parentNode;
      sliderParent.addEventListener('mouseenter', function () {
        clearInterval(startPlay);
      });
      sliderParent.addEventListener('mouseleave', function () {
...
function Slider() {
  ...
  //get parent
  this.container = document.querySelector(container); //get childrens of the parent

  try {
    this.slides = this.container.children;
  } catch (e) {} //get btn to swipe slides
  ...
  this.autoplay = autoplay; //start with
