...
function () {
  function Slider(page, btns) {
    ...
    //get parent
    this.page = document.querySelector(page); //get childrens of the parent

    this.slides = this.page.children; //get btn to swipe slides

    this.btns = document.querySelectorAll(btns); //start with
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      } catch (e) {} //if we clicked then plusSlides
